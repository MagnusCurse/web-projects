...
@Table(name = "posts") // Specifies the name of the database table for this entity
@NoArgsConstructor
@AllArgsConstructor
@Getter
@Setter
...
public class Post {
    ...
    // Defines a many-to-one relationship with the User entity. LAZY fetching means the User is loaded only when accessed.
    @ManyToOne(fetch = FetchType.LAZY)
    // Specifies the foreign key column in the 'posts' table that links to the 'users' table
