...
class ApiService {
  ...
  // Make a POST request to '/auth/register' endpoint with the user's credentials
  // credentials contains email and password from the registration form
  public async register(credentials: RegisterRequest): Promise<AuthResponse> {
